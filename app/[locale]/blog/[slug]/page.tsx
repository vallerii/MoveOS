...
export default async function ArticlePage({ params }: { params: Params }) {
  ...
  return (
    <main className="bg-paper py-16 sm:py-section">
      <div className="container-page max-w-3xl">
        <Link href={`/${locale}`} className="link-arrow group">
        ...
        <h1 className="mt-6 font-display text-heading-lg text-ink">{article.title}</h1>
