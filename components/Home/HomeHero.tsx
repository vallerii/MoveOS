 ...
 *
 * The artifacts themselves are NOT rendered here. They're owned by
 * HomeStage, which flies them from this section into the next one on
 * scroll. What sits here instead are four invisible slots marking where
 * each artifact starts; HomeStage measures them at runtime. The slot boxes
 * carry the artifacts' real widths so the measurement is accurate.
 */
  ...
  return (
    <section className="relative overflow-hidden bg-paper pb-24 pt-16 sm:pb-32 sm:pt-24">
      ...
      <div className="container-page relative z-10">
        {/* Recedes on scroll while the artifacts move forward — the two
            layers separate rather than scrolling away as one. */}
        <RecedingTitle>
          <div className="mx-auto max-w-3xl text-center">
            ...
            <Reveal delay={200}>
              <p className="mx-auto mt-8 max-w-xl whitespace-pre-line text-body text-slate">
